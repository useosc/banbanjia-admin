...
if ($_W["isajax"] && $_W["ispost"]) {
    ...
    $data = pdo_fetchall("SELECT * FROM " . tablename("hello_banbanjia_members") . "WHERE uniacid = :uniacid AND addtime >= :starttime and addtime <= :endtime", array(":uniacid" => $_W["uniacid"], ":starttime" => $start, "endtime" => $end));
    foreach ($data as $da) {
