define(["jquery.ui"], function (a) {
    ...
    b.initParts = function () {
        ...
        if (b.checkPluginExist("svip") && (a[1].push("svipGuide"), a[2].push("svipGuide")), b.has_gohome && 2 != b.type && a[0].push("gohomeActivity"), !b.has_gohome || 1 != b.type && 4 != b.type && 5 != b.type || a[0].push("haodianGroup"), b.has_gohome && 4 == b.type && (a[0].push("haodianSettle"), a[0].push("tongcheng"), a[0].push("tongchengStatistics")), b.has_gohome && 5 == b.type && (a[0].push("haodianList"), a[0].push("haodianSettle")), b.type > 0 && a[b.type]) var c = b.iconcat(a[b.type], a[0]);
        else var c = a[0];
        $.each(c, function (a, c) {
            var d = b.parts[c];
    ...
    b.initTpl = function () {
        tmodtpl.helper("tomedia", function (a) {
            return 0 == a.indexOf("images/") ? b.attachurl + a : "string" != typeof a ? "" : 0 == a.indexOf("http://") || 0 == a.indexOf("https://") || 0 == a.indexOf("../addons/we7_wmall/") ? a : 0 == a.indexOf("images/") || 0 == a.indexOf("audios/") ? b.attachurl + a : void 0
        }),
    ...
    b.initSave = function () {
        $(".btn-save").unbind("click").click(function () {
            return $(this).data("status") ? void Notify.error("正在保存，请稍候。。。") : (b.data = {}, b.data = {
                page: b.page,
                items: b.items
            }, b.page.title ? ($(".btn-save").data("status", 1).text("保存中..."), void irequire(["tiny"], function (a) {
