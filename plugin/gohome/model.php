...
function gohome_update_activity_flow($activity_type, $goods_id, $type)
{
    ...
    $routers = array("pintuan" => array("table" => "hello_banbanjia_pintuan_goods"), "kanjia" => array("table" => "hello_banbanjia_kanjia"), "seckill" => array("table" => "hello_banbanjia_seckill_goods"), "article" => array("table" => "hello_banbanjia_article_information"));
