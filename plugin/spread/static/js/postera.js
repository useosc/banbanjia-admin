	...
	diy.getParts = function(){
		diy.parts = {
			background: {
				...
				params: {
					name: '背景图',
					imgurl: '../addons/hello_banbanjia/plugin/spread/static/img/bg.jpg',
				},
			...
			avatar: {
				name: '头像',
				params: {
					avatar: '../addons/hello_banbanjia/plugin/spread/static/img/head.jpg',
				},
			...
			image: {
				name: '图片',
				params: {
					imgurl: '../addons/hello_banbanjia/plugin/spread/static/img/image.jpg',
				},
				style: {'top': '10', 'left': '10', 'width': '80', 'height': '80', 'z-index': 1},
			},
			qrcode: {
				name: '二维码',
				params: {
					imgurl: '../addons/hello_banbanjia/plugin/spread/static/img/qrcode.jpg',
					type: "wechat",
				},
	...
	diy.initSave = function() {
		$(".btn-save").unbind('click').click(function() {
			...
			irequire(['hello'], function(hello){
				$.post(hello.getUrl('spread/postera/post'), {id: diy.id, data: diy.data}, function(ret) {
					var ret = ret.message;
					if(ret.errno != 0) {
